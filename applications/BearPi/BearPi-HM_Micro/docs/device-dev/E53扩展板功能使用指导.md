...
**说明:**<br>
&emsp;本次E53模组主要包括E53_IA1(智慧农业模块),E53_IS1(人体感应模块),E53_SC1(智慧路灯模块),E53_SC2(智慧井盖模块),E53_SF1(可燃气体检测模块)。目前已经适配好E53接口的底层驱动放在 `device/st/drivers`路径下面,感兴趣的读者可以去翻阅一下。另外，E53模组的底层驱动也已经可以直接调用。用户层可以通过获取驱动发布的服务使用模块。<br>
